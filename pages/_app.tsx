...
function Spin() {
  return (
    <svg role="status" className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-cyan-200" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  useEffect(() => {
    const handleStart = setLoading.bind(null, true)
    const handleStop = setLoading.bind(null, false)
